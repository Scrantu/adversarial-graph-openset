...
def main():
    ...
    # Loss weights
    # good:(0.01, 0.001)
    parser.add_argument('--lambda_ixz', type=float, default=0.01, help='Weight for I(X;Z) loss')
    parser.add_argument('--lambda_struct', type=float, default=0.01, help='Weight for structure KL loss')
    ...
    adj = load_npz_as_pyg_data("C:/Users/zhaoc/Desktop/DeepRobust-latest/examples/graph/data/mod_graph_cora-0.7-0.1-0.1-0-MetaSelf-0.15/mod_adj.npz")
    ...
    print(f"\nBest validation/test overall accuracy/test ind accuracy/openset detection: {best_val:.4f}/{best_overall_test:.4f}/{best_known_in_test:.4f}/{accs['openset']}, model saved to {args.save_path}")
